...
namespace LampStore.Migrations
{
    ...
    [Migration("20230217160246_InfoPropLinkAdd")]
    partial class InfoPropLinkAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LampStore.Models.ProductType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LampStore.Models.Tag", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductTag", b =>
                {
                    ...
                    b.HasKey("ProductTagsID", "ProductsProductID");
            ...
            modelBuilder.Entity("ProductTag", b =>
                {
                    b.HasOne("LampStore.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("ProductTagsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LampStore.Models.Product", null)
                        .WithMany()
